...
annotation('textbox',[.45 0.96 .3 .04],'String',['Simulation Time : ',num2str(tSim),' s'],'EdgeColor','blue')
 ...
 print(figAnalitics,[ruta 'img_statistics_direct',num2str(k)],'-dpdf');  

 %% Inserto registro en log 'outputLog' 
    outputLog = fopen([ruta 'outputLog_direct_',num2str(k),'.csv'],'a');
    for i=1:numUAVs
        fprintf(outputLog,'%+05.2f,%+05.2f,%+05.2f,%05.2f,%05.2f,%05.2f,%05.2f,%05.2f,%05.2f,%05.2f\n' ...
                 ,i                    ...
                 ,distTotal(i)         ...
                 ,distDirect(i)        ...
                 ,air.timeTotal(i)     ...

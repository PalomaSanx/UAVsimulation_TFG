...
%             end
            ...
            box2_ = fill(...
                    [box2.W box2.E box2.E box2.W],...
                    [box2.N box2.N box2.S box2.S],...
                    'r',...
                    'EdgeColor','none','LineWidth',0.5,...
            ...
            OBvel_ = plot([0 UAVvel(i,1) OBvel(1)],[0 UAVvel(i,2) OBvel(2)],'ko-');
            ...
            box2_.XData = [box2.W box2.E box2.E box2.W];
            box2_.YData = [box2.N box2.N box2.S box2.S];

            box_.XData = [box.W box.E box.E box.W];
            box_.YData = [box.N box.N box.S box.S];

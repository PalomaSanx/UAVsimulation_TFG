...
_ Gestión dinámica de colisiones en entornos con múltiples drones _
...
* **Paloma SÃ¡nchez** - *Desarrollo* - [palomasanx](https://github.com/PalomaSanx)

## Licencia ğŸ“„

Este proyecto estÃ¡ bajo la Licencia (OpenSource) - mira el archivo [LICENSE.md](LICENSE.md) para detalles

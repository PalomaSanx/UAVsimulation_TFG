...
annotation('textbox',[.45 0.96 .3 .04],'String',['Simulation Time : ',num2str(tSim),' s'],'EdgeColor','blue')
 ...
 print(figAnalitics,['./img_output_2/img_statistics_',num2str(k-1)],'-dpdf');  

 %% Inserto registro en log 'outputLog' 
    outputLog = fopen('./img_output_2/outputLog.csv','a');
    for i=1:numUAVs
        fprintf(outputLog,['',num2str(k-1),',%+05.2f,%+05.2f,%+05.2f,%05.2f,%05.2f,%05.2f,%05.2f,%05.2f,%05.2f,%05.2f\n'] ...
                 ,i                    ...
                 ,distTotal(i)         ...
                 ,distDirect(i)        ...
                 ,air.timeTotal(i)     ...
